...
<head>
    ...
    <title>My Products - AgroCraft</title>
    <!-- Bootstrap CSS -->
    ...
    <main class="container my-4">
        <div class="row">
            <div class="col-12 text-center mb-4">
                <h2>Your Products</h2>
                <a href="InsertProduct.php" class="btn btn-success"><i class="fas fa-plus-circle"></i> Add New Product</a>
            </div>
        </div>
        <div class="row">
            <?php
            if (isset($_SESSION['phonenumber'])) {
                ...
                echo "<div class='col-12'><div class='alert alert-warning text-center'>Please <a href='../auth/FarmerLogin.php'>login</a> to see your products.</div></div>";
            }
            ?>
        </div>
    </main>
